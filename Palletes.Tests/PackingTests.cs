...
public sealed class PackingTests
{
    ...
    public void Pack_SimpleBoxes_NoOverlap_InsidePallet()
    {
        ...
        var placements = PalletPacker.Pack(boxes, pallet, seed: 1);
    ...
    public void Pack_Cubes50_ShouldStayLowHeight()
    {
        ...
        var placements = PalletPacker.Pack(boxes, pallet, seed: 12345);
    ...
    public void PackCsv_WritesValidCsv_FromDatasetGeneratorInput()
    {
        ...
        PalletPacker.PackCsv(inPath, outPath, pallet, seed: 7);
    ...
    public void PackCsv_CanSplitAcrossMultiplePallets()
    {
        ...
        PalletPacker.PackCsv(inPath, outPath, pallet, seed: 11);
    ...
    public void PackCsv_StillReadsLegacyCsvWithAisleColumn()
    {
        ...
        PalletPacker.PackCsv(inPath, outPath, pallet, seed: 13);
    ...
    public void PackCsv_CanPlacePalletsIntoMultipleContainers()
    {
        ...
        PalletPacker.PackCsv(inPath, outPath, pallet, container, seed: 17);
    ...
    public void PackCsv_RespectsPalletMaxWeight()
    {
        ...
        PalletPacker.PackCsv(inPath, outPath, pallet, seed: 23);
    ...
    public void PackCsv_DoesNotStackCausticAndRegularItemsTogether()
    {
        ...
        PalletPacker.PackCsv(inPath, outPath, pallet, seed: 29);
